...
// Setup screen view-model. Aligns with the planned RecordingCore contract
// (RecordingSource + RecordingInputSelection); field names will be renamed to the
// core types once Mini finalizes them. The runtime supplies sources/scenes + a
// live previewLevel for the focused source.
export interface RecordSource {
  id: string;
  kind: "system" | "app" | "microphone";
  label: string;
  bundleId?: string;
  appName?: string;
}
...
export interface RecordInputSelection {
  sourceId: string;
...
export function RecordSetupView({
  ...
  const micApplicable = selected?.kind !== "microphone";
