...
enum UITestIDs {
    ...
    enum Panel {
        ...
        static let autoStopPrompt = "recappi.panel.autoStopPrompt"
        static let autoStopKeepButton = "recappi.panel.autoStopKeepButton"
        static let autoStopStopButton = "recappi.panel.autoStopStopButton"
    ...
    enum Cloud {
        ...
        static let speakerNameButtonPrefix = "recappi.cloud.speakerNameButton."
        static let speakerRenamePopover = "recappi.cloud.speakerRenamePopover"
        static let speakerRenameNameField = "recappi.cloud.speakerRenameNameField"
        static let speakerRenameSaveButton = "recappi.cloud.speakerRenameSaveButton"
