...
public enum CaptureBundleCollapser {
    private static let helperMarkers: [String] = [
        ".helper", ".Helper",
        ".renderer", ".Renderer",
        ".agent", ".Agent",
        ".plugin_host",
    ...
    public static func matches(_ bundleID: String, selected selectedBundleID: String) -> Bool {
    ...
    public static func canonicalBrowserBundleID(for appName: String) -> String? {
    ...
    public static func browserDisplayName(for bundleID: String, fallback: String) -> String {
